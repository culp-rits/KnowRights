...
const Game1pg2 = () => {
  return (
    <div className="absolute top-[1160px] left-[0px] [background:linear-gradient(#3a0ca3,_#3a0ca3),_#2d2d39] shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] w-[1440px] h-[1024px] text-left text-13xl text-white font-russo-one">
      ...
      />
      <div className="absolute top-[219px] left-[491px] shadow-[-5px_5px_25px_#fd654e] w-[457px] h-[647px]">
        <img
          className="absolute top-[48px] left-[37px] w-[457px] h-[551px] object-cover"
          alt=""
          src="/white-simple-student-cv-resume-11@2x.png"
        />
        <img
          className="absolute top-[0px] left-[0px] w-[457px] h-[647px] object-cover"
          alt=""
          src="/white-simple-student-cv-resume-1-11@2x.png"
        />
      </div>
