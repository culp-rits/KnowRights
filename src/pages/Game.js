        ...
        <div className="flex flex-row px-[5%] pb-[5%] min-h-[70vh]">
            <div className="flex flex-col w-[50%]">
                <div className="flex flex-row">
                    ...
                    <Link to="/game/choose">
                        <img className=" w-[50%] my-10 mx-20 rounded-full hover:bg-white hover:bg-opacity-25 active:bg-blue-400 active:bg-opacity-75 " src="arrow-right-fill0-wght400-grad0-opsz24-1.svg" alt="" />
                    </Link>
                </div>
